...
def _cache_path(timeframe: str, symbol: str, cache_date: datetime) -> str:
    ...
    Args:
        ...
        cache_date: Datetime from get_cache_date (date=period_start.date, hour=closing hour)

    Returns:
        Path like "2026/07/21/XAUUSD/h4-16-analysis.json"
    """
...
def get_cache_date(timeframe: str, broker_now: datetime) -> datetime:
