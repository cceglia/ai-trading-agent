...
class DataSource(Protocol):
    ...
    def get_candles(
        self, symbol: str, timeframe: str, count: int, *, broker_now: datetime | None = None
    ) -> str:
        ...
        Args:
            ...
            broker_now: Optional naive datetime in broker-local time used as
                the reference point for lookback calculations. When omitted
                (None), the provider's default (typically UTC now) is used.
